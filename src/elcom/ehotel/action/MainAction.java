...
public class MainAction extends ActionConstant implements ActionBasic, ModelDriven<ObjectBean>,
	...
	public String save_main() {
		try {
			...
			String path_flag_source = ReadWriteUtils.getProperty("PATH_IMAGE");
...
/*			String filePath_flag = request.getSession().getServletContext().getRealPath("/");
			String path_flag = Utils.getParentPath(filePath_flag) + path_flag_source+subfix;*/
			...
			Utils.createFileImage_EHotel(request,objectBean.getFile_image(), image_name, path_flag, null);
