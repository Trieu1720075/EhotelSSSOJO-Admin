...
(function($) {
	$.fn.numeric = function(config, callback) {
		...
		var decimalPlaces = typeof config.decimalPlaces == "undefined" ? -1
				: config.decimalPlaces;
		callback = typeof callback == "function" ? callback : function() {
		};
		return this.data("numeric.decimal", decimal).data("numeric.negative",
				negative).data("numeric.callback", callback).data(
				"numeric.decimalPlaces", decimalPlaces).keypress(
	...
	$.fn.numeric.keypress = function(e) {
		...
		if (e.ctrlKey && key == 118 || e.ctrlKey && key == 86 || e.shiftKey
				&& key == 45) {
			return true
		}
		if (key < 48 || key > 57) {
			var value = $(this).val();
			if ($.inArray("-", value.split("")) !== 0
					&& negative
					&& key == 45
	...
	$.fn.numeric.blur = function() {
		...
		var val = this.value;
		if (val !== "") {
			var re = new RegExp(negative ? "-?" : "" + "^\\d+$|^\\d*" + decimal
					+ "\\d+$");
			if (!re.exec(val)) {
				callback.apply(this)
			}
	...
	$.fn.removeNumeric = function() {
		return this.data("numeric.decimal", null)
				...
				.data("numeric.decimalPlaces", null).unbind("keypress",
