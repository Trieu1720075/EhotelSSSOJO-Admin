...
<script	src="${pageContext.request.contextPath}/MODULE-WELCOME/js/module-video.js"></script>
...
<body>
	...
	<div class="container">
		...
		<div class="col-xs-12 col-md-7">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body" style="overflow-x: hidden;overflow-y: auto; height: 417px;">
		...
		<div class="col-xs-12 col-md-12" style="margin-top: 50px; margin-bottom: 10px">
			<ul class="nav nav-tabs">
				<li class="active"><a href="#welcome-bg-welcome" data-toggle="tab">
					<s:property value="getText('welcome.backgound.welcome')" /></a>
				</li>
				<li ><a href="#welcome-bg-standby" data-toggle="tab">
					<s:property value="getText('welcome.backgound.standby')" /></a>
				</li>
				<li ><a href="#welcome-bg-music" data-toggle="tab">
					<s:property value="getText('welcome.backgound.music')" /></a>
				</li>
				<li ><a href="#welcome-video" data-toggle="tab">
					<s:property value="getText('welcome.video')" /></a>
				</li>
				<li><a href="#welcome-birthday" data-toggle="tab">
					<s:property value="getText('welcome.birthday')" />
					</a>
				</li>
			...
			<div class="tab-content ">
				<div class="tab-pane active" id="welcome-bg-welcome">
					<div class="" style="margin-top: 0px; margin-bottom: 500px">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="" id="id_put_data_background">
				...
				<div class="tab-pane" id="welcome-bg-standby">
					<div class="" style="margin-top: 0px; margin-bottom: 50px">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="" id="item-background-standby">
				...
				<div class="tab-pane" id="welcome-bg-music">
					<div class="" style="margin-top: 0px; margin-bottom: 50px">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="" id="item-background-music">
				...
				<div class="tab-pane" id="welcome-video">
					<div class="" style="margin-top: 0px; margin-bottom: 10px">
						<div style="margin-bottom:10px">
								<button class="btn btn-primary btn-sm" type="button" onclick="openNewDialogVideo()" >
									<i class="fa fa-plus-circle"></i>
									<s:property value="getText('button.add')" />
								</button>
						</div>
							...
							<div class="panel-body">
								<table id="table-item-video" class="table text-left">
									<thead>
										<tr>
											<th width="10%">
												<s:property	value="getText('item.no')" />
											</th>
											<th width="30%">
												<s:property	value="getText('item.name')" />
											</th>
											<th width="40%">
												<s:property	value="getText('item.link')" />
											</th>
											<th width="10%">
												<s:property value="getText('item.status')" />
											</th>
											<th width="10%">
												<s:property	value="getText('item.action')" />
											</th>
										</tr>
									</thead>
				...
				<div class="tab-pane" id="welcome-birthday">
									...
									<thead>
										<tr>
											<th width="10%"><s:property
													value="getText('item.no')" /></th>
											<th width="30%"><s:property
													value="getText('item.name')" /></th>
											<th width="40%"><s:property
													value="getText('item.link')" /></th>
											<th width="10%"><s:property
					...
					<div id="form-edit-birthday" class="" style="display: none;">
						<div class="row">
							<div class="col-md-6">
								<div class="row" style="margin-bottom:15px">
									...
									<div class="col-md-10"><input id="birthday-name" type="text" style="width: 100%;"></div>
								</div>
								<div class="row" style="margin-bottom:10px">
									<label class="col-md-2"> Name </label>
									<div class="col-md-10"><input id="bdcustomer" class="form-control" disabled type="text" style="width: 100%;"></div>
								</div>
								<div class="row" style="margin-bottom:15px">
									<label class="col-md-2"> Color </label>
									<div class="col-md-4"><input id="bdcustomer-color" type="color"></div>
								...
								<div class="row" style="margin-bottom:10px">
									...
									<div class="col-md-10"><input id="birthday-text" type="text" style="width: 100%;"></div>
								</div>
								<div class="row" style="margin-bottom:15px">
									<label class="col-md-2"> Color </label>
									<div class="col-md-4"><input id="birthday-color" type="color"></div>
									<label class="col-md-2"> Font size </label>
									<div class="col-md-4">
								...
								<div class="row" style="margin-bottom:10px">
									...
									<div class="col-md-6"><input id="bday-image" type='file' accept="image/jpeg, image/png"></div>
								...
								<div class="row" style="margin-bottom:10px">
									...
									<div class="col-md-10">
											<div class="input-append timepicker">
												<input id="birthday-duration" type="text" data-format="hh:mm:ss" style="width: auto !important;"
													class="input-time" maxlength="8" placeholder="hh:mm:ss" required="required"/>
												<span class="add-on">
													<i class="icon-time" data-date-icon="icon-calendar"></i>
												</span>
											</div>
											
											<input id="bday-id" type="hidden" />
											<input type="hidden" id="birthday-url" />
									</div>
								</div>
								<div class="row" style="margin-bottom:10px">
						...
						<div class="row">
							<div class="col-md-12">
								<iframe id="birthday_iframe" src="about:blank" width="" height="600" style="width: 100%;border: 1px solid lightgrey;"></iframe>
							</div>
						</div>
					</div>
						...
						<label class="control-label col-sm-12" for="pwd"><s:property value="getText('welcome.button.background')"/>:</label>						
							...
							<div class="col-md-12">
								<div>
									...
									<input id="name_background" name="name_background"
										type="hidden">
								</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<label class="control-label col-sm-12" for="pwd"><s:property value="getText('welcome.button.background')"/>:</label>						
							...
							<div class="col-md-12">
								<div>
									<input id="file_background_music" name="file_background_music" type="file"
										class="file-loading"
	...
	<div id="video-dialog" class="modal fade" role="dialog">
		<form id="item-upload-form-video" action="${pageContext.request.contextPath}/upload-file-video-welcome.elcom" 
			...
			<div class="modal-dialog" style="width: 500px;">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
							...
							<tr>
								<td colspan="6">
									<div class="input-group">
									  	<div id="item-container-error-video" class="alert alert-danger" style="display: none"></div>
									</div>			
								</td>
							</tr>						
							<tr>					
								...
								<td>
									<input type="text" name="name" id="item-name-video" style="width: 100%">
								</td>
							</tr>
							<tr>
								<td width="10%"><s:property value="getText('item.status')"/></td>
								<td width="15%" id="status-td-video">
								</td>
							</tr>				
							<tr>
								<td><s:property value="getText('item.link')"/></td>
								<td>
									<input type="text" name="mediaName" id="item-link-video" style="width: 100%" readonly="readonly">
								</td>							
							</tr>
							<tr>
								<td></td>
						...
						<input type="hidden" id="item-host-video" name="host">
						<input type="hidden" id="item-port-video" name="port">
						<input type="hidden" id="item-user-video" name="user">
						<input type="hidden" id="item-pass-video" name="pass">
						<input type="hidden" id="item-type-video" name="type">
						<input type="hidden" id="item-path-video" name="mediaPath">
						<input type="hidden" id="item-index-video" name="item-index">
					</div>
					<div class="modal-footer">	
						<button type="submit" class="btn btn-sm btn-primary btn-save"></button>
						<button type="button" class="btn btn-sm btn-danger" onclick="closeDialogItemVideo()">
	...
	<div id="video-delete-dialog" class="modal fade" role="dialog">
		<div class="modal-dialog" style="width: 400px;">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title"><s:property value="getText('welcome.delete.video')"/></h5>
				</div>
				<div class="modal-body">
					<s:property value="getText('mv.delete.item.confirm')"/> "<span style="color: red;" id="item-delete-video"></span>" ?
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-sm btn-danger" onclick="deleteVideo()"><s:property value="getText('button.yes')"/></button>
