		 ...
		 type : "GET",
			...
			success : function(response) {
				...
				$.each(response, function(i, item) {	
					...
					if (item.id == 24) {
						html +='<div class="col-md-3 mng-mystay" style="margin-bottom: 10px;">';
						...
						html +='<div class="col-md-3 mng-info" style="margin-bottom: 10px;">';
						html +='<div class="thumbnail text-center margin_thumnail_main" style="height: 150px;width: 150px;" data-id="'+item.id+'">';
						html += '<a href="' + getValueField("contextPath") + '/main/main-retaurent.elcom?id=' + item.id + '">';
					} 
					else if (item.id == 23) {
						html +='<div class="col-md-3 mng-interaction" style="margin-bottom: 10px;">';
						html +='<div class="thumbnail text-center margin_thumnail_main" style="height: 150px;width: 150px;" data-id="'+item.id+'">';
						html += '<a href="' + getValueField("contextPath") + '/main/myhotel.elcom">';
					} 
					else if(item.id==16){
						html +='<div class="col-md-3 mng-message" style="margin-bottom: 10px;">';
						html +='<div class="thumbnail text-center margin_thumnail_main" style="height: 150px;width: 150px;" data-id="'+item.id+'">';
						html +='<a  href="' + getValueField("contextPath") + '/main/main-message.elcom?id='+item.id+'">';	
					}
					else if(item.id==4){
						html +='<div class="col-md-3 mng-movie" style="margin-bottom: 10px;">';
						html +='<div class="thumbnail text-center margin_thumnail_main" style="height: 150px;width: 150px;" data-id="'+item.id+'">';
						html +='<a  href="' + getValueField("contextPath") + '/movies/movies.elcom">';	
					}
					else if(item.id==3){
						html +='<div class="col-md-3 mng-music" style="margin-bottom: 10px;">';
						html +='<div class="thumbnail text-center margin_thumnail_main" style="height: 150px;width: 150px;" data-id="'+item.id+'">';
						html +='<a  href="' + getValueField("contextPath") + '/music/music.elcom">';	
					}
					else if(item.id==2){
						html +='<div class="col-md-3 mng-livetv" style="margin-bottom: 10px;">';
						html +='<div class="thumbnail text-center margin_thumnail_main" style="height: 150px;width: 150px;" data-id="'+item.id+'">';
...
function EditMain_(){
	...
	if(document.getElementById("file_lag_update").files.length != 0){
		 ...
		 oData.append("txt_noidung", txt_noidung);
		 oData.append("file_image", file_lag);
		 oData.append("index", txt_index_update);
		 $.ajax({
				type : "POST",
