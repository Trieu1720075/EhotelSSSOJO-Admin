...
<script src="${pageContext.request.contextPath}/MODULE-MAIN/js/module-main-children.js"></script>
						...
						<table id="table-item" class="table text-left" style="width: 100%">
							<thead>
								<tr>
									...
									<th width="30%"><s:property value="getText('item.link')"/></th>
									<%-- <th ><s:property value="getText('item.image')"/></th> --%>
									<th width="10%"><s:property value="getText('item.status')"/></th>									
									<th width="15%"><s:property value="getText('item.action')"/></th>
								</tr>
							</thead>
							<tbody id="tbody-item">
							</tbody>
			...
			<div class="text-right">							
		        ...
		        <input type="text" id="file_name" name="file_name" placeholder="Enter file name here" ></input>			        		      
		            <select name="size" id="cbb_change" >
		                ...
		                <option value="temp8">Template 8</option>			
		                 <option value="temp9">Template 9</option>		
...
<div id="item-delete-dialog" class="modal fade" role="dialog">
	<div class="modal-dialog" style="width: 400px;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<s:property value="getText('subject.delete.title')"/> "<span style="color: red;" id="item-delete"></span>" ?
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-sm btn-danger" onclick="deleteSubjectMain()"><s:property value="getText('button.yes')"/></button>
...
<div id="delete-dialog-item" class="modal fade" role="dialog">
	<div class="modal-dialog" style="width: 400px;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<s:property value="getText('subject.delete.title')"/> "<span style="color: red;" id="item-delete-item"></span>" ?
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-sm btn-danger" onclick="deleteContentInfoChildrent()"><s:property value="getText('button.yes')"/></button>
				<button type="button" class="btn btn-sm btn-default" data-dismiss="modal"><s:property value="getText('button.no')"/></button>
			</div>
		</div>
	</div>
