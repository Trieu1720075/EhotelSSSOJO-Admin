...
<div id="item-dialog" class="modal fade" role="dialog">
	<form id="item-upload-form" action="${pageContext.request.contextPath}/upload-file-myhotel.elcom" 
...
<div id="item-delete-dialog" class="modal fade" role="dialog">
	<div class="modal-dialog" style="width: 400px;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<s:property value="getText('hotel.delete.item.confirm')"/> "<span style="color: red;" id="item-delete"></span>" ?
			</div>
			<div class="modal-footer">
...
<script src="${pageContext.request.contextPath}/MODULE-MAIN/js/myhotel.js"></script>