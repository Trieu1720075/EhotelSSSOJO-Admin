...
<div id="item-dialog" class="modal fade" role="dialog">
	<form id="item-upload-form"
		action="${pageContext.request.contextPath}/upload_file_dining_icon.elcom"
...
<script src="${pageContext.request.contextPath}/MODULE-MAIN/js/module-main-dining.js"></script>