		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#channel-livetv" data-toggle="tab"><s:property value="getText('livetv.channel')" /></a></li>
					<li><a href="#channel-video" data-toggle="tab">Video Channel</a></li>	
					<li><a href="#announce-livetv" data-toggle="tab"><s:property value="getText('livetv.announce')" /></a></li>
					<li><a href="#mode-livetv" data-toggle="tab"><s:property value="getText('livetv.mode')" /></a></li>
				</ul>
						...
						<div class="col-md-10 col-md-offset-1">
							<div class="panel panel-default">
								<div class="panel-heading text-right">
									<button type="button" class="btn btn-info btn-sm" onclick="openMyhotelNewDialog()">
										<i class="fa fa-floppy-o"></i> <s:property value="getText('button.add')"/>
									</button>
								</div>
								<div class=" panel-body container-item-myhotel" id="container-item-myhotel">
							...
							<div class="col-md-6 col-xs-6 col-lg-6 col-xs-offset-3">
								<div class="form-horizontal" style="margin-top:20px">
									<div class="form-group">
										<div class="col-md-4">
											<label class="control-label"><s:property value="getText('livetv.announce')"/></label>
										</div>
										<div class="col-md-8">
											<div class="colourpicker-input-container">
												<textarea class="form-control" id="txt_announcement" rows="4" style="background-color:#a2a2a2" ></textarea>
											</div>
										</div>										
									</div>
									
									<div class="form-group">
										<div class="col-md-4"><label class="control-label"><s:property value="getText('livetv.color')"/></label></div>
										<div class="col-md-8">
											<input class="form-control" type="color" id="ip_color_livetv" style="width:40px" onchange="changeColorAnnounce()" />
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-4"><label class="control-label"><s:property value="getText('livetv.bg.color')"/></label></div>
										<div class="col-md-8">
											<!--<input class="form-control" type="color" id="ip_bg_color" style="width:40px" onchange="changeColorAnnounce()" /> -->
											<div style="width:70px"><input type="text" id="ip_bg_clpicker" class="form-control my-cp" onchange="changeColorAnnounce()"></div>
										</div>
									</div>																
									<div class="form-group">
										<div class="col-md-4"><label class="control-label">Font size</label></div>
										<div class="col-md-8">
									...
									<div class="form-group">
										<div class="col-md-4"><label class="control-label"><s:property value="getText('livetv.duration')"/></label></div>
										<div class="col-md-8">
											<div class="input-append timepicker">
												<input id="duration-livetv" type="text" data-format="hh:mm:ss" style="width: auto !important;"
													class="input-time" maxlength="8" placeholder="hh:mm:ss" required="required" onchange="onchangeInputTime()">
												<span class="add-on">
									...
									<div class="form-group">
										<div class="col-md-4"><label class="control-label"><s:property value="getText('livetv.announce.turnon')"/></label></div>
										<div class="col-md-8">
									...
									<div class="form-group pull-right">
										<button class="btn btn-primary btn-sm" id="btn_annoucne_livetv"  onclick="updateAnnounceLivetv()"><i class="fa fa-floppy-o"></i> <s:property value="getText('button.save')"/></button>
									</div>
...
<script src="${pageContext.request.contextPath}/MODULE-LIVETV/js/announcement-livetv.js"></script>
...
<script src="${pageContext.request.contextPath}/MODULE-LIVETV/js/myhotel.js"></script>