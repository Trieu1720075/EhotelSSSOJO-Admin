...
$(function(){	
	...
	$( "#cbb_change" ).on( "change", function() {		
		...
		if(temp_==="temp0"){
			...
			$("#div_center").empty();
			$("#id_form").empty();
			var temp8=Template_8.load();
			$("#div_center").append(temp8);
			...
			$("#div_center").empty();
			$("#id_form").empty();
			var temp9=Template_9.load();
			$("#div_center").append(temp9);
				
			//var form_temp7=Template_7.form();
			//$("#id_form").append(form_temp7);
		}else if(temp_==="temp10"){
			$("#div_center").empty();
			$("#id_form").empty();
			var temp10=Template_10.load();
			$("#div_center").append(temp10);
...
Template1.load = function() {//<div class="col-xs-12 col-md-12" style="padding:0px !important" id="div-content">
	...
	temp+=		'<img id="myImg" src="../MODULE-COMMON/images/no-image.png" style="width: 100%;margin-top: 5px;"/>';
	temp+='</div>';
	...
	temp+='<font color="white">Click here to input text ...</font>';
	temp+='</div>';
	temp+='</div>';
	return temp;
...
Template_2.load = function() {	
	...
	var temp='<div class="col-xs-12 col-md-12 div-content" id="div-content" style="padding: 0px!important;">'
		...
		+'<img src="../MODULE-COMMON/images/no-image.png" id="myImg" width="100%";margin-top: 5px; >'
		+'</div>'
		+'<div class="col-xs-12 col-md-12 content text-left" id="content-paste">'
		+'<font color="white">Click here to input text ...</font>'
		+'</div>'
		+'</div>';
...
Template_3.load = function() {
	...
	temp+='<div class="col-xs-7 col-md-7 text-left" id="content-paste" style="word-wrap: break-word;padding:0px 0px 0px 10px !important">';
	temp+='<font color="white"><font color="white">Click here to input text ...</font></font>';
	temp+='</div>';
	temp+='<div class="col-xs-5 col-md-5" style="padding:0px !important">';
	temp+=		'<img id="myImg" src="../MODULE-COMMON/images/no-image.png" style="width: 100%; margin-top: 5px;"/>';
	temp+='</div>';
...
Template_4.load = function() {	
	...
	temp+='<img src="../MODULE-COMMON/images/no-image.png"  style="width: 100%; margin-top: 5px;" id="myImg">';
	temp+='</div>';
...
Template_5.load = function() {	
	...
	var temp='<div class="col-xs-12 col-md-12 div-content" id="div-content" style="padding: 0px!important;">'		
		+'<img src="../MODULE-COMMON/images/no-image.png" id="myImg" width="100%"  style= "padding:5px 5px 5px 5px;">'		
		+'</div>';
	return temp;
}
...
Template_6.load = function() {	
	...
	var temp='<div class="col-xs-12 col-md-12 div-content" id="div-content" style="padding: 0px!important;">'		
		...
		+'<font color="white"><font color="white">Click here to input text ...</font></font>'
		+'</div>';
...
Template_7.load = function() {	
	...
	var temp='<div class="col-xs-12 col-md-12 div-content" id="div-content" style="padding: 0px!important;">'
		...
		+'<img src="../MODULE-COMMON/images/no-image.png" id="myImg"  style="width: 100%; margin-top: 5px;">'
		+'</div>'
		+'<div class="col-xs-12 col-md-12 text-left " id="content-paste" style="background: #11293b;word-wrap: break-word;">'
		+'<font color="white">Click here to input text ...</font>'
		+'</div>'
		+'</div>';
...
Template_8.load = function() {			
	var temp = '<div class="col-xs-12 col-md-12 div-content" id="div-content" style="padding: 0px!important; ">'		
			+ '<div  class="div-image" style="position:relative;">'
			+ '<img src="../MODULE-COMMON/images/no-image.png" id="myImg" width="100%"  style= "padding:5px 5px 5px 5px; ">'
			+ '</div>'
			+ '<div id="content-paste" class="div-tool-template" style=" left: 4px; ">'
			+ '<font color="white">Click here to input text ...</font>'
			+ '</div>'
			+ '</div>' 			
	return temp;
...
Template_9.load = function() {			
	var temp = '<div class="col-xs-12 col-md-12 div-content" id="div-content" style="padding: 0px!important; ">'		
			+ '<div  class="div-image" style="position:relative;">'
			+ '<img src="../MODULE-COMMON/images/no-image.png" id="myImg" width="100%"  style= "padding:5px 5px 5px 5px; ">'
			+ '</div>'
			+ '<div id="content-paste" class="div-tool-template" style=" right: 4px; ">'
			+ '<font color="white">Click here to input text ...</font>'
			+ '</div>'
			+ '</div>' 			
	return temp;
...
Template_10.load = function() {			
	var temp = '<div class="col-xs-12 col-md-12 div-content" id="div-content" style="padding: 5px!important; ">'		
			+ '<div  class="div-image" style="position:relative;">'
			+ '<img src="../MODULE-COMMON/images/no-image.png" id="myImg" width="100%"  >'
			+ '</div>'
			+ '<div id="content-paste" class="div-tool-template-vertical">'
			+ '<font color="white">Click here to input text ...</font>'
			+ '</div>'
			+ '</div>' 			
	return temp;
