				...
				<div class="modal-body">
					<table class="tableLayout">
						...
						<tr>
							...
							<td width="10%"><s:property value="getText('item.isnew')"/></td>
							<td width="15%" id="isnew-td">
							</td>		
							<td><s:property value="getText('item.description')"/></td>
							<td>
								<input type="text" name="description" id="item-description" style="width: 100%"/>
							</td>
						</tr>				
						<tr>
...
<div id="item-delete-dialog" class="modal fade" role="dialog">
	<div class="modal-dialog" style="width: 400px;">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title"><s:property value="getText('mv.delete.item.title')"/></h5>
			</div>
			<div class="modal-body">
				<s:property value="getText('mv.delete.item.confirm')"/> "<span style="color: red;" id="item-delete"></span>" ?
			</div>
			<div class="modal-footer">
...
<script src="${pageContext.request.contextPath}/MODULE-MUSICVIDEO/js/subject.js"></script>
<script src="${pageContext.request.contextPath}/MODULE-MUSICVIDEO/js/item.js"></script>