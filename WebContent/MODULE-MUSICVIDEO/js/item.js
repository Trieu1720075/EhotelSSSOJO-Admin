...
function createTableItem(data) {
	...
	$.each(data, function(i, item) {
		...
		col5.appendChild(createItemInvisible_(id,name,plot,link,image,invisible,isnew));
...
function createItemInvisible_(id,name,plot,link,image,invisible,isnew) {
	var str = "'" + id + "','" + name+ "','" + plot+ "','" + link+"','"+image+"','"+invisible+"','"+isnew+"'";
...
function changeStatusData(id,name,plot,link,image,invisible,isnew){
